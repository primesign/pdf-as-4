...
public class SignatureCreationService extends Service {
    ...
    static {
        URL url = SignatureCreationService.class.getResource("/home/afitzek/devel/pdf-as-4/src/pdf-as-4/pdf-as-moa/src/main/resources/wsdl/MOA-SPSS-1.5.2.wsdl");
        if (url == null) {
            url = SignatureCreationService.class.getClassLoader().getResource("/home/afitzek/devel/pdf-as-4/src/pdf-as-4/pdf-as-moa/src/main/resources/wsdl/MOA-SPSS-1.5.2.wsdl");
        } 
        if (url == null) {
