 ...
 * @author John Hewson
 */
public final class DefaultSecHandlerFactory
{
    /** Singleton instance */
    public static final DefaultSecHandlerFactory INSTANCE = new DefaultSecHandlerFactory();
    ...
    private DefaultSecHandlerFactory()
    {
